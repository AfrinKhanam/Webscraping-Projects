...
namespace IndianBank_ChatBOT.Dialogs.Deposits
{
    public class DepositResponses : TemplateManager
    {
        ...
        public class DepositResponseLinks
        {
            ...
            public const string FdRipRdAccounts = "https://www.indianbank.in/departments/nre-fd-rip-rd-accounts/#!";
            public const string NreSbAccounts = "https://www.indianbank.in/departments/nre-sb-accounts/#!";
            public const string NonResidentOrdinaryAccount = "https://www.indianbank.in/departments/non-resident-ordinary-account/#!";
            public const string FcnrAccounts = "https://www.indianbank.in/departments/fcnr-b-accounts/#!";
        }
