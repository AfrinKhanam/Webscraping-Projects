...
namespace BOTAIML.ChatBot.DirectLineServer.Core.Services
{
    ...
    {
        private readonly DirectLineSettings _settings;
        ...
        public DirectLineHelper(IOptions<DirectLineSettings> settings, IHttpClientFactory clientFactory, IConversationHistoryStore history)
        {
