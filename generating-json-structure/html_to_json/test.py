...
services_ind_mobile_banking = services_path + 'premium/' + 'ind_mobile_banking.json'
services_mca_payment = services_path + 'premium/' + 'mca_payment.json'
services_multicity_cheque_facility = services_path + 'premium/' + 'multicity_cheque_facility.json'
...
services_ib_home_security = services_path + 'insurance/' + 'ib_home_security.json'
services_jeevan_kalyan = services_path + 'insurance/' + 'jeevan_kalyan.json'
services_universal_health_care = services_path + 'insurance/' + 'universal_health_care.json'
services_vidyarthi_suraksha = services_path + 'insurance/' + 'vidyarthi_suraksha.json'
services_griha_jeevan = services_path + 'insurance/' + 'griha_jeevan.json'
services_jana_shree_bhima_yojana = services_path + 'insurance/' + 'jana_shree_bhima_yojana.json'
...
sb_for_students_under_govt_scholarship = savings_bank_account_path + 'sb_for_students_under_govt_scholarship.json'
sb_for_central_state_govt = savings_bank_account_path + 'sb_for_central_state_govt.json'
...
covid_emergency_salary_loan = covid_products_path + 'covid_emergency_salary_loan.json'
covid_emergency_pension_loan = covid_products_path + 'covid_emergency_pension_loan.json'
...
ind_covid_emergency_poultry_loan = covid_products_path + 'ind_covid_emergency_poultry_loan.json'
ind_mse_covid_emergency_loan = covid_products_path + 'ind_mse_covid_emergency_loan.json'

#---------------------------ALLAHABAD BANK-----------------------------------------------------------
allahabad_bank_path = './config_files/config_files_v2/about_us/allahabad/'
md_ceo_msg_on_allahabad_bank = allahabad_bank_path + 'md_ceo_msg_on_allahabad_bank.json'
faqs_for_amalgamation = allahabad_bank_path + 'faqs_for_amalgamation.json'
amalgamation_of_allahabad_into_indianbank = allahabad_bank_path + 'amalgamation_of_allahabad_into_indianbank.json'
...
corporate_social_responsibility = news_path + 'corporate_social_responsibility.json'
