...
namespace IndianBank_ChatBOT.Dialogs.NewsInfo
{
    public class NewsInfoResponses : TemplateManager
    {
        ...
        public static Dictionary<string, NewsInfoResponses.NewsInfoData> keyValuePairs = new Dictionary<string, NewsInfoResponses.NewsInfoData>
        {
            ...
            { "indian bank trust rural development",new NewsInfoData{NewsInfoDataTitle="Indian Bank Trust For Rural Development (IBTRD)",NewsInfoDataText="To know more about Indian Bank Trust For Rural Development (IBTRD). Please click on Read More",NewsInfoDataLink=NewsInfoResponseLinks.IndianBankTrustForRuralDevelopment,NewsInfoDataImagePath=""} },
            ...
            { "indian bank mutual fund",new NewsInfoData{NewsInfoDataTitle="INDIAN BANK MUTUAL FUND",NewsInfoDataText="To know more about INDIAN BANK MUTUAL FUND. Please click on Read More",NewsInfoDataLink=NewsInfoResponseLinks.IndianBankMutualFund,NewsInfoDataImagePath=""} }
        };
        ...
        {
            // news info Links
            public const string Notification = "https://www.indianbank.in/departments/notifications/#!";
            public const string NewsLetter = "https://www.indianbank.in/departments/newsletter/#!";
            public const string WhatsNew = "https://www.indianbank.in/what-is-new/#!";
            public const string SmsBanking = "https://www.indianbank.in/sms-banking/#!";
            public const string ScanAndPay = "https://www.indianbank.in/wp-content/uploads/2018/04/QR_UserGuidepdf.pdf";
            public const string MyDesignCard = "https://apps.indianbank.in/imagecard/";
            public const string PressReleases = "https://www.indianbank.in/press-releases/#!";
            public const string Downloads = "https://www.indianbank.in/departments/downloads/#!";

            //customer corner links
            public const string CustomerComplaintForm = "https://www.indianbank.in/wp-content/uploads/2018/03/customercomplaintform.pdf";
            public const string OnlineCustomerComplaints = "https://www.indianbank.in/departments/online-customer-complaints/#!";
            public const string NodalOfficersBankingOmbudsmanScheme = "https://www.indianbank.in/nodal-officers-banking-ombudsman-scheme-2016/#!";
            public const string NodalOfficersCustomerService = "https://www.indianbank.in/nodal-officers-customer-service/#!";
            public const string PrincipalCodeComplianceOfficer = "https://www.indianbank.in/principal-code-compliance-officers-bcsbi/#!";
            public const string DamodaranCommitteeRecommendations = "https://www.indianbank.in/damodaran-committee-recommendations/#!";
            public const string BankingOmbudsman = "https://www.indianbank.in/banking-ombudsman/#!";
            public const string RemitToIndia = "https://www.indianbank.in/remit-of-india/#!";
            public const string AadhaarEnrollment = "https://www.indianbank.in/wp-content/uploads/2018/03/AADHAR_enrol_eng.pdf";
            public const string ProcedureOnLocker = "https://www.indianbank.in/wp-content/uploads/2018/03/Procedure_safe_dep_locker-1.pdf";
            public const string CoinVendingMachines = "https://www.indianbank.in/wp-content/uploads/2018/03/CVMs_Chennai.pdf";
            public const string IndianBankTrustForRuralDevelopment = "https://www.indianbank.in/wp-content/uploads/2018/03/IBTRD_30082014.pdf";
            public const string LowCostMobileBankingThroughUSSD = "https://www.indianbank.in/wp-content/uploads/2018/03/LowCostMobileBanking_USSD.pdf";

            //Related Info links
            public const string FAQs = "https://www.indianbank.in/departments/f-a-qs/#!";
            public const string OnlineCustomerComplaintsRelatedInfo = "https://www.indianbank.in/wp-content/uploads/2018/03/PMJDY_FAQ_2014-2.pdf";
            public const string FAQsOnPradhanMantriJanDhanYojana = "https://www.indianbank.in/wp-content/uploads/2018/03/PMJDY_FAQ_2014-2.pdf";
            public const string RecoveryAgentsEmpanelledEngagedByBand = "https://www.indianbank.in/wp-content/uploads/2018/03/RecoveryAgent_IB.pdf";
            public const string ECS_NoticeToCustomers = "https://www.indianbank.in/wp-content/uploads/2018/03/ECSNoticetoCustomers.pdf";
            public const string ListOfHolidays = "https://www.indianbank.in/wp-content/uploads/2018/03/ECSNoticetoCustomers.pdf";
            public const string Disclaimer = "https://www.indianbank.in/departments/disclaimer/#!";
            public const string SecurityAlert = "https://www.indianbank.in/wp-content/uploads/2018/03/security_alert.pdf";

            //codes/policy/disclosures links
            public const string RightsOfBanksCustomers = "http://bcsbi.org.in/pdf/PictorialBookEnglish.pdf";
            public const string DealingDishonourOfCheques = "https://www.indianbank.in/wp-content/uploads/2018/11/Policy-on-Dealing-with-frequent-dishonour-of-Cheques-and-ECS-2018.19.pdf";
            public const string DepositPolicy = "https://www.indianbank.in/wp-content/uploads/2018/03/policy_Deposit.pdf";
            public const string BestPracticesCodeOfTheBank = "https://www.indianbank.in/departments/best-practices-code-of-the-bank/#!";
            public const string CodesOfBanksCommitmentToCustomers = "https://www.indianbank.in/wp-content/uploads/2018/09/Code-of-Banks-Commitment-to-Customers-2018.pdf";
            public const string PolicyOnDeterminingMaterialSubsidiary = "https://www.indianbank.in/wp-content/uploads/2018/03/Policyondeterminingmaterialsubsidiary.pdf";
            public const string PolicyOnDeterminationAndDisclosureOfMaterialEvents = "https://www.indianbank.in/wp-content/uploads/2018/03/PolicyonDeterminingMaterialityofEvents.pdf";
            public const string PolicyOnRealtedPartyTransactions = "https://www.indianbank.in/wp-content/uploads/2018/03/RPTPOLICY2015.pdf";
            public const string PolicyGuidelinesOnEmpanelmentOfValuers = "https://www.indianbank.in/wp-content/uploads/2018/03/BankPolicyGuidelinesonEmpanelmentofValuers.pdf";
            public const string PolicyAppointmentOfStatutoryCentral = "https://www.indianbank.in/wp-content/uploads/2018/04/190114072416_0001.pdf";
            public const string RightToInformationAct = "https://www.indianbank.in/wp-content/uploads/2018/03/drs-sme.pdf";
            public const string Disclosures = "https://www.indianbank.in/wp-content/uploads/2018/03/drs-sme.pdf";
            public const string CustomerCentricServices = "https://www.indianbank.in/departments/customer-centric-services/#!";
            public const string DebtRestructingMechanismForSMES = "https://www.indianbank.in/wp-content/uploads/2018/03/drs-sme-1.pdf";
            public const string FairLendingPracticesCode = "https://www.indianbank.in/wp-content/uploads/2018/03/FairLendingPracticesCode.pdf";
            public const string ProcessingFees = "https://www.indianbank.in/wp-content/uploads/2018/03/FairLendingPracticesCode.pdf";//page not found
            public const string ProcessingChargesInAgriTermLoans = "https://www.indianbank.in/wp-content/uploads/2018/03/ChargesinAgriTermLoansJLSHGloanJL.pdf";
            public const string ProcessingChargesofHome = "https://www.indianbank.in/wp-content/uploads/2018/03/FairlendingPractice_HomePlotVehcileLoan.pdf";
            public const string ProcessingChargesOfSME_Products = "https://www.indianbank.in/wp-content/uploads/2018/03/FairLendingPractises_MSME.pdf";
            ...
            public const string AgriculturalDebtWaiver = "https://www.indianbank.in/departments/agricultural-debt-waiver-and-debt-relief-scheme-2008/#!";
            public const string ChartersBankingOmbudsman = "https://www.indianbank.in/wp-content/uploads/2018/04/BankingOmbudsman2006.pdf";
            public const string FinancialInclusionPlan = "https://www.indianbank.in/departments/financial-inclusion-plan-2010-12-name-of-villages-and-field-bcs/#!";
            public const string RestructuredAccounts = "https://www.indianbank.in/departments/restructured-accounts/#!";
            public const string ServicesRenderedFreeOfCharge = "https://www.indianbank.in/departments/services-rendered-free-of-charge/#!";
            public const string WelfareOfMinorities = "https://www.indianbank.in/departments/welfare-of-minorities/#!";
            public const string WhistleBlowerPolicy = "https://www.indianbank.in/departments/whistle-blower-policy/#!";
            public const string CentralizedPensionProcessingSystem = "https://www.indianbank.in/departments/centralized-pension-processing-systems/#!";
            public const string AnotherOptionForPension = "https://www.indianbank.in/departments/another-option-for-pension/#!";
            public const string CitizensCharter = "https://www.indianbank.in/wp-content/uploads/2018/03/citizen_charter-1.pdf";
            public const string IndianBankMutualFund = "https://www.indianbank.in/wp-content/uploads/2018/03/ibmf.pdf";
        }
