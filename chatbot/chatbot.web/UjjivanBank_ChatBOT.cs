...
namespace UjjivanBank_ChatBOT
{
    ...
    /// </summary>
    public class UjjivanBank_ChatBOT : IBot
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UjjivanBank_ChatBOT"/> class.
        /// </summary>
        /// <param name="botServices">Bot services.</param>
        /// <param name="conversationState">Bot conversation state.</param>
        /// <param name="userState">Bot user state.</param>
        public UjjivanBank_ChatBOT(BotServices botServices, ConversationState conversationState, UserState userState,
...

        {
            ...
            _dialogs = new DialogSet(_conversationState.CreateProperty<DialogState>(nameof(UjjivanBank_ChatBOT)));
