...
namespace IndianBank_ChatBOT.Migrations
{
    ...
    [Migration("20210207175543_HindiLanguageSelection")]
    partial class HindiLanguageSelection
    {
            ...
            modelBuilder.Entity("IndianBank_ChatBOT.Models.StaticPage", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2021, 2, 7, 23, 25, 43, 128, DateTimeKind.Local).AddTicks(756));
            ...
            modelBuilder.Entity("IndianBank_ChatBOT.Models.WebScrapeConfig", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2021, 2, 7, 23, 25, 43, 129, DateTimeKind.Local).AddTicks(5811));
