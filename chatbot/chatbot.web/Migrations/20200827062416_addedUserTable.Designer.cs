...
namespace IndianBank_ChatBOT.Migrations
{
    ...
    [Migration("20200827062416_addedUserTable")]
            ...
            modelBuilder.Entity("IndianBank_ChatBOT.Models.StaticPage", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2020, 8, 27, 11, 54, 16, 292, DateTimeKind.Local).AddTicks(7685));
            ...
            modelBuilder.Entity("IndianBank_ChatBOT.Models.WebScapeConfig", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2020, 8, 27, 11, 54, 16, 296, DateTimeKind.Local).AddTicks(2327));
