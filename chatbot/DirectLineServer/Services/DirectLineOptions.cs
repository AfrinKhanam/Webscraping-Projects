namespace BOTAIML.ChatBot.DirectLineServer.Core.Services
{
    ...
    public class DirectLineSettings
    {
        ...
        /// Note the ServiceUrl is different from the `--urls` listened by DirectLine server. The `--urls` might be used internally (let's say it sits behind a reverse proxy).
        /// </summary>
        /// <value></value>
