...
{
    public class DirectLineConversationHandler : ChannelServiceHandler
    {

        private readonly ILogger<DirectLineConversationHandler> _logger;
        private readonly IDirectLineConnectionManager _connectionManager;
        private readonly DirectLineHelper _helper;

        public DirectLineConversationHandler(ILogger<DirectLineConversationHandler> logger, IDirectLineConnectionManager connectionManager, DirectLineHelper helper, ICredentialProvider credentialProvider, AuthenticationConfiguration authConfiguration, IChannelProvider channelProvider = null)
        ...
        protected override async Task<ResourceResponse> OnReplyToActivityAsync(ClaimsIdentity claimsIdentity, string conversationId, string activityId, Activity activity, CancellationToken cancellationToken = default)
        {
            ...
            {
                var resource = new DirectLineConversationResourceResponse
                {
                    Id = activity.Id,
                    Status = 400,
        ...
        protected override async Task<ResourceResponse> OnUpdateActivityAsync(ClaimsIdentity claimsIdentity, string conversationId, string activityId, Activity activity, CancellationToken cancellationToken = default)
        {
            ...
            return new DirectLineConversationResourceResponse
            {
                Id = activity.Id,
                Status = 400,
        ...
        internal class DirectLineConversationResourceResponse : ResourceResponse
        {
