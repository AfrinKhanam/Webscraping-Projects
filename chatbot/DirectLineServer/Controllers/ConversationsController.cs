...
namespace BOTAIML.ChatBot.DirectLineServer.Core.Controllers
{
    ...
    public class ConversationsController : Controller
    {
        ...
        private readonly IOptions<DirectLineSettings> _settings;
        private readonly DirectLineHelper _helper;
        private readonly IDirectLineConnectionManager _connectionManager;

        public ConversationsController(ILogger<ConversationsController> logger, IOptions<DirectLineSettings> opt, DirectLineHelper helper, IDirectLineConnectionManager connectionManager)
        {
            this._logger = logger;
            this._settings = opt;
            this._helper = helper;
